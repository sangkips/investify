                            ...
                            <div class="ms-auto lh-1">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item active" href="#">Last 7 days {{$last7DaysOrders}}</a>
                                        <a class="dropdown-item" href="#">Last 30 days {{$last30DaysOrders}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="h1 mb-3">{{ $todayOrders}}</div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto lh-1">
                                <div class="dropdown">
                                    <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item active" href="#">Last 7 days {{ $totalOrdersLast7Days }}</a>
                                        <a class="dropdown-item" href="#">Last 30 days {{ $totalOrdersLast30Days }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-auto lh-1">
                                <!-- <div class="dropdown">
                                    <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item active" href="#">Today {{ $todayCustomers }}</a>
                                        <a class="dropdown-item active" href="#">Last 7 days {{ $last7DaysCustomers }}</a>
                                        <a class="dropdown-item" href="#">Last 30 days {{ $last30DaysCustomers }}</a>
                                    </div>
                                </div> -->
                            </div>
                        </div>
                        <div class="d-flex align-items-baseline">
                            <div class="h1 mb-3 me-2">{{ $customers }}</div>
                            <div class="me-auto">
