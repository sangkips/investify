                ...
                <div class="col-lg-4">
                    <div class="modern-card">
                        ...
                        <div class="profile-upload-section">
                            <img class="profile-image-preview" src="{{ $supplier->photo ? asset('storage/'.$supplier->photo) : asset('assets/img/demo/user-placeholder.svg') }}" alt="" id="image-preview" />
                ...
                <div class="col-lg-8">
                    <div class="modern-card">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('kra_pin') is-invalid @enderror" id="kra_pin" name="kra_pin" value="{{ old('kra_pin', $supplier->kra_pin) }}" required>
                                        @error('kra_pin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-grid">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                            ...
                                            <option value="{{ $bank }}" @selected(old('bank_name', $supplier->bank_name) == $bank)>{{ $bank }}</option>
                                            @endforeach
                                        </select>
                                        @error('bank_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="action-buttons">
                            <a href="{{ route('suppliers.show', $supplier->uuid) }}" class="btn-cancel">
