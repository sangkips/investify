                ...
                <div class="col-lg-4">
                    <div class="modern-card">
                        ...
                        <div class="profile-upload-section">
                            <img class="profile-image-preview" src="{{ $customer->photo ? asset('storage/'.$customer->photo) : asset('assets/img/demo/user-placeholder.svg') }}" alt="" id="image-preview" />
                            <p class="upload-hint">JPG or PNG no larger than 2 MB</p>
                ...
                <div class="col-lg-8">
                    <div class="modern-card">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('kra_pin') is-invalid @enderror" id="kra_pin" name="kra_pin" value="{{ old('kra_pin', $customer->kra_pin) }}" required>
                                        @error('kra_pin')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-grid">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                            ...
                                            <option value="{{ $bank }}" @selected(old('bank_name', $customer->bank_name) == $bank)>{{ $bank }}</option>
                                            @endforeach
                                        </select>
                                        @error('bank_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="action-buttons">
                            <a href="{{ route('customers.show', $customer->uuid) }}" class="btn-cancel">
