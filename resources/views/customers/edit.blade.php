                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img class="img-account-profile mb-2" src="{{ $customer->photo ? asset('storage/' . $customer->photo) : asset('assets/img/demo/user-placeholder.svg') }}" alt="" id="image-preview" />
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <x-input label="Account holder" name="account_holder" :value="old('account_holder', $customer->account_holder)" :required="true" />
                                    </div>

                                    <div class="col-sm-6 col-md-6">
                                        <x-input label="Account number" name="account_number" :value="old('account_number', $customer->account_number)" :required="true" />
                                    </div>
