...
<style>
    ...
    .category-view-header-content h1 {
        font-size: 1.5rem;
        font-weight: 700;
        color: white;
        margin: 0 0 4px;
    ...
    .category-view-header-content p {
        font-size: 0.875rem;
    ...
    .category-view-footer .text-secondary {
        font-size: 0.875rem;
        color: var(--text-light);
    }

    /* Pagination styling - reduce pages shown */
    .pagination {
        display: flex;
        gap: 4px;
        flex-wrap: wrap;
    ...
    /* Show only: prev, first 2, active, last 2, next */
    ...
    @media (max-width: 768px) {
        ...
        /* Simplified mobile pagination - hide middle page numbers */
        .mobile-view .pagination .page-item {
            display: none;
        }

        /* Show only first, last, prev, next and active page */
        .mobile-view .pagination .page-item:first-child,
        .mobile-view .pagination .page-item:last-child,
        .mobile-view .pagination .page-item:nth-child(2),
        .mobile-view .pagination .page-item:nth-last-child(2),
...
<div class="category-view-card">
    ...
    <div class="category-view-header">
        <div class="category-view-header-content">
            <h1>
            ...
            <p>{{ $products->total() }} {{ __('products in this category') }}</p>
        </div>
    ...
    <div wire:loading.remove class="desktop-view table-responsive">
        ...
        <div class="empty-state">
            ...
            <p>{{ __('No products in this category yet.') }}</p>
        </div>
        @endif
    </div>
    ...
    <!-- Desktop Footer -->
    @if($products->count() > 0)
    <div class="category-view-footer desktop-view">
