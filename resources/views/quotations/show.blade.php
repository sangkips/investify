                ...
                <div class="card-body">
                    <div class="row row-cards mb-3">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" id="purchase_no" class="form-control" value="{{ $quotation->reference }}" disabled>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" id="supplier" class="form-control" value="{{ $quotation->customer_name }}" disabled>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" id="create_by" class="form-control" value="{{ $quotation->tax_percentage ?? null }}" disabled>
                        </div>
